...
function deferredRequest(data) {
    return new Promise((resolve, reject) => {
        sendRequest(data, (e, response) => {
            // reject(new Error('Foo barred'));
            // return;
            if(e) {
                reject(e);
                return;
...
module.exports.slideshows = {
    ...
    query(site_ids, page) {
        ...
        // &sort_direction=desc
        return deferredRequest({
            endpoint: `/slideshows/?limit=20&site_ids%5B%5D=${site_ids.join(',')}&page=${page}`,
            options: {}
        });
    },
    create(site_id) {
    ...
    update(slideshow) {
        return deferredRequest({
            ...
            options: {
                method: 'PATCH',
                json: Object.assign(slideshow, { status: 'listed' })
            }
        });
    }
};
        ...
        return deferredRequest({
            ...
            options: {
                ...
                json: Object.assign({
                    ...
                    image_url_secondary: slide.image
                }, slide)
            }
        });
    },
